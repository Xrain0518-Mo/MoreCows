package com.momo.morecows.item.misc.armor;

import com.momo.morecows.item.IGuaEnhance;
import com.momo.morecows.item.armor.ItemArmorBase;
...
import static com.momo.morecows.util.NBTStrDef.IDLNBTDef.MODE;
